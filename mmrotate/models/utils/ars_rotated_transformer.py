...
class ARSRotatedDeformableDetrTransformer(Transformer):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(ARSRotatedDeformableDetrTransformer, self).__init__(**kwargs)
    ...
    def forward(self,
        ...
        if self.as_two_stage:
            ...
            topk_angle = angle_coder.decode(topk_angle_cls.detach())
            init_reference_angle_out = reference_angle = topk_angle
            ...
            init_reference_out = reference_points
            init_reference_angle_out = reference_angle = torch.zeros((
                reference_points.shape[0], reference_points.shape[1]
            ), dtype=torch.float32).to(reference_points.device)
...
class ARSRotatedDeformableDetrTransformerDecoder(TransformerLayerSequence):
    ...
    def __init__(self, *args, return_intermediate=False, **kwargs):
        ...
        super(ARSRotatedDeformableDetrTransformerDecoder, self).__init__(*args, **kwargs)
